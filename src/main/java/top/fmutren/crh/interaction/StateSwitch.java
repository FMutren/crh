...
public class StateSwitch {
    ...
    static {
        shaftCasingType.put("brass_casing", "create:brass_encased_shaft");
        shaftCasingType.put("andesite_casing", "create:andesite_encased_shaft");

        pipeCasingType.put("copper_casing", "create:encased_fluid_pipe");
